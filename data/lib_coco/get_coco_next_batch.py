...
annotation_path = '/home/wangguojun/dataset/coco/annotations/instances_train2014.json'
...
def next_img(step):
    ...
    img = cv2.imread(os.path.join("/home/wangguojun/dataset/coco/train2014", imgname))
