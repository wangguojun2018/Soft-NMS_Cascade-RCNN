...
def detect(det_net, inference_save_path, test_imgname_list):
    ...
    with tf.Session(config=config) as sess:
        ...
        for i, a_img_name in enumerate(test_imgname_list):
            ...
            tools.view_bar('{} image cost {}s'.format(a_img_name, (end - start)), i + 1, len(test_imgname_list))
