...
def train():
    ...
    tf.summary.scalar('cls_loss_3', cls_loss_3)
    tf.summary.scalar('bbox_loss_1',bbox_loss_1)
    tf.summary.scalar('bbox_loss_2', bbox_loss_2)
    tf.summary.scalar('bbox_loss_3', bbox_loss_3)
    ...
    # trainable_variables_names=[v.name for v in slim.get_trainable_variables()]
    # print('*'*20)
