...
def train():
    ...
    cls_loss_1 = loss_dict['cls_loss_1']
    cls_loss_2 = loss_dict['cls_loss_2']
    cls_loss_3 = loss_dict['cls_loss_3']
    bbox_loss_1 = loss_dict['bbox_loss_1']
    bbox_loss_2 = loss_dict['bbox_loss_2']
    bbox_loss_3 = loss_dict['bbox_loss_3']
    ...
    with tf.Session(config=config) as sess:
        ...
        for step in range(cfgs.MAX_ITERATION):
            ...
            if step % cfgs.VALIDATE_INTE==0:
                ...
                rpnLocLoss_val, rpnClsLoss_val, Cls_loss_1_val,Bbox_loss_1_val, \
                    Cls_loss_2_val,Bbox_loss_2_val,Cls_loss_3_val,Bbox_loss_3_val,totalLoss_val = \
                        sess.run(
                            [rpn_location_loss, rpn_cls_loss, cls_loss_1,bbox_loss_1,
                             cls_loss_2,bbox_loss_2,cls_loss_3,bbox_loss_3, total_loss], feed_dict={img_plac: img_val, gtbox_plac: gt_info_val})
            else:
                if step % cfgs.SHOW_TRAIN_INFO_INTE == 0 and step % cfgs.SMRY_ITER != 0:
                    start = time.time()
                    _, global_stepnp, rpnLocLoss, rpnClsLoss, Cls_loss_1,Bbox_loss_1, \
                    Cls_loss_2,Bbox_loss_2,Cls_loss_3,Bbox_loss_3, totalLoss = \
                        sess.run(
                            [train_op, global_step, rpn_location_loss, rpn_cls_loss, cls_loss_1,bbox_loss_1,
                             cls_loss_2,bbox_loss_2,cls_loss_3,bbox_loss_3, total_loss],
                        feed_dict={img_plac: img, gtbox_plac: gt_info})
                    end = time.time()
                    print("""{}: step{}  image_name:{}  rpn_loc_loss:{}  rpn_cla_loss:{}  cls_loss_1:{} bbox_loss_1:{}\n \ cls_loss_2:{}  bbox_loss_2:{}  cls_loss_3:{}  bbox_loss_3:{}  total_loss:{}  per_cost_time:{}s \n \n""" \
                          .format(training_time, global_stepnp, str(img_id), rpnLocLoss, rpnClsLoss,
                                  Cls_loss_1, Bbox_loss_1, Cls_loss_2, Bbox_loss_2,Cls_loss_3,Bbox_loss_3, totalLoss, (end - start)))
                else:
